      ...
      <div className="flex justify-center items-center md:w-1/2 p-8 bg-gray-200 bg-opacity-70 backdrop-filter backdrop-blur-lg">
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
          ...
          <form  className="space-y-4">
            ...
            <button onClick={handleSubmit} type="submit" className="w-full mt-6 bg-teal-500 text-white font-bold py-2 rounded-lg shadow-lg hover:bg-teal-600 transition duration-300">Sign Up</button>
